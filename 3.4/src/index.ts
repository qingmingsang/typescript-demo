...
//let result1 = buildName4("Bob");                  // error, too few parameters
//let result2 = buildName4("Bob", "Adams", "Sr.");  // error, too many parameters
let result33 = buildName4("Bob", "Adams");         // okay and returns "Bob Adams"
...
let h2 = new Handler3();
//uiElement.addClickListener(h2.onClickGood);// error!
